...
public static class MediaTypeNames
{
    ...
    public const string ApplicationXShockwaveFlash =
    ...
    public const string ApplicationVndMsPowerpoint =
    ...
    public const string ApplicationVndMozillaXulXml =
    ...
    public const string ApplicationXPkcs7Certificates =
    ...
    public const string ApplicationXPkcs7Certreqresp =
        "application/x-pkcs7-certreqresp";

    ///<summary>p7s files</summary>
    public const string ApplicationXPkcs7Signature =
    ...
    public const string ApplicationXRarCompressed =
