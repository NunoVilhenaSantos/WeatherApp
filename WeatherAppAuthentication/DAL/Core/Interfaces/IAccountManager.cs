...
public interface IAccountManager
{
    ...
    Task<(bool Succeeded, string[] Errors)> DeleteRoleAsync(
        ApplicationRole role);

    Task<(bool Succeeded, string[] Errors)> DeleteRoleAsync(string roleName);

    Task<(bool Succeeded, string[] Errors)> DeleteUserAsync(
    ...
    Task<List<ApplicationRole>>
        GetRolesLoadRelatedAsync(int page, int pageSize);
